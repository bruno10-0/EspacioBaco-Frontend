      ...
      <div className="relative flex flex-col-reverse md:flex-row items-start md:gap-6 gap-2 mt-16 md:mt-32 w-full bg-base-200 md:p-10">
              ...
              {cartList.map((producto, index) => (
                ...
                >
                  ...
                  <div className="w-full flex justify-around gap-6 border-b py-4">
                    ...
                    <div className="w-24 md:w-1/2 flex items-start flex-col  gap-2">
                      ...
                      <div className="flex justify-center items-start">
                        <button className="text-accent text-xs md:text-base">
                          Eliminar
                        </button>
                      </div>
                    </div>
                    <div className="w-20 md:w-2/12 flex flex-col justify-start items-center gap-2">
                      <div className="w-full p-2 flex justify-between gap-2 items-center border border-accent">
                        ...
                        <span className="text-xs md:text-base text-accent">
                          100
                        </span>
                        <button>
                  ...
                  <div className="font-bold w-full py-4 flex justify-between">
                    <h1>Envío</h1>
                    <h1 className="text-success ">Gratis</h1>
                  </div>
                  <div className="w-full flex-col flex gap-2 my-2 ">
                    ...
                    <div className="text-xs md:text-base">
                      ...
                      <Link to="/vinoteca" className="text-accent items-center">
                        Ver más productos.
                      </Link>
                    </div>
                    <p className="text-sm">
                      Los envíos gratuitos son válidos para Posadas únicamente.
                    </p>
                  </div>
                </div>
              ))}
        ...
        <div className="sticky top-16 md:sticky md:top-40 p-3 w-full md:w-1/3 shadow-sm bg-base-100 z-10">
          ...
          <div className="flex justify-between mb-2">
            <h2 className="text-sm md:text-base px-4">Productos()</h2>
            <h2 className="text-sm md:text-base px-4">$valor</h2>
          </div>
          <div className="flex justify-between mb-2">
          ...
          <div className="flex justify-between font-bold mb-4">
            ...
            <h2 className="px-4 ">$valor</h2>
          </div>
          <div className="w-full flex justify-center items-center">
            <button className="btn btn-accent text-base-100 w-4/5">
              Continuar compra{" "}
            </button>
          </div>
        </div>
