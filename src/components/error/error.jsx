...
export const Error = () => {
    return (
        <div>
            <div className="relative body-error bg-base-300 w-full h-screen flex flex-col justify-center text-center items-center gap-4">
                <h1 className="text-error text-5xl">404</h1>
                <h2 style={{ letterSpacing: "1px" }}>La página que estás buscando no se encontró</h2>
                <button>
                    <Link className="btn bg-primary text-base-100 font-light shadow-md border-none" to="/" style={{ letterSpacing: "4px" }}>Volver al inicio</Link>
                </button>
